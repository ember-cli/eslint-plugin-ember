...
eslintTester.run('no-decorators-before-export', rule, {
	...
	invalid: [
		// basic
		{
			...
			errors: ['Usage of class decorator on the export Foo must occur prior to exporting the class.'],
		},
		{
			code: `import classic from 'ember-classic-decorators';\n@classic\nexport default class Foo {}`,
			output: `import classic from 'ember-classic-decorators';\n@classic\nclass Foo {}\nexport default Foo;\n`,
		...
		},
		{
			code: `import classic from 'ember-classic-decorators';\n@classic\nexport default class {}`,
			output: `import classic from 'ember-classic-decorators';\n@classic\nexport default class {}`,
			errors: ['Usage of class decorator on the un-named default export must occur prior to exporting the class.'],
		},
		// ensure interop
		{
			code: `import classic from 'ember-classic-decorators';\n@classic\nexport class Foo {\n  someProp = false;\n}\nexport class Bar {};\n`,
