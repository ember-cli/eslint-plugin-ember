...
module.exports = {
  meta: {
    ...
    messages: {
      main:
        'The service `{{name}}` is not referenced in this JS file, but it may still be referenced in the corresponding HBS file. Please remove this service if it is not being used within the HBS file.',
