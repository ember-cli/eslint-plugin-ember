  ...
  create(context) {
    ...
    return {
      ...
      VariableDeclarator(node) {
        ...
        const isEmberDestructuringAssignment = isIdentifier(node.init) && node.init.name === emberImportAliasName;
        if (isEmberImported && isModuleScope && isEmberDestructuringAssignment) {
