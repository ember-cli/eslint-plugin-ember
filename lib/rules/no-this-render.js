...
const ERROR_MESSAGE = "Do not use `this.render(). Prefer @ember/test-helpers' `render` instead.`";
...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      category: 'Testing',
      url:
        'https://github.com/ember-cli/eslint-plugin-ember/tree/master/docs/rules/no-this-render.md',
    },
    fixable: null,
    schema: [],
  },
