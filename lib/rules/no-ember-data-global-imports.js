...
const { buildFix, buildMessage, isInitImportedFrom } = require('../utils/new-module');
...
module.exports = {
  meta: {
    docs: {
      ...
      recommended: false,
      url:
        'https://github.com/ember-cli/eslint-plugin-ember/tree/master/docs/rules/no-ember-data-global-imports.md',
    },
    fixable: 'code',
  },
