...
module.exports = {
  ...
  meta: {
    ...
    docs: {
      ...
      recommended: false,
      url:
        'https://github.com/ember-cli/eslint-plugin-ember/tree/master/docs/rules/no-tryinvoke.md',
    },
    fixable: null,
    schema: [],
  },
    ...
    return {
      ImportDeclaration(node) {
        ...
        if (importSource === '@ember/utils') {
          importedTryInvokeName = importedTryInvokeName || getImportIdentifier(node, '@ember/utils', 'tryInvoke');
        }
      },
