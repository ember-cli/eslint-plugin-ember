...
module.exports = {
  ...
  'ember/template-modifier-name-case': 'error',
  ...
  'ember/template-no-jsx-attributes': 'error',
  ...
  'ember/template-no-only-default-slot': 'error',
  ...
  'ember/template-no-splattributes-with-class': 'error',
  ...
  'ember/template-no-unavailable-this': 'error',
  ...
  'ember/template-no-yield-block-params-to-else-inverse': 'error',
  ...
  'ember/template-require-iframe-src-attribute': 'error',
