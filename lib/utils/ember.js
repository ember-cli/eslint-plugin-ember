...
module.exports = {
  ...
  isRedirectProp,
  isActivateProp,
  isSetupControllerProp,
  isRenderTemplateProp,
  isResetControllerProp,
  isDeactivateProp,
...
function isBeforeModelProp(property) {
  return property.key.name === 'beforeModel' && utils.isFunctionExpression(property.value);
}
...
function isAfterModelProp(property) {
  return property.key.name === 'afterModel' && utils.isFunctionExpression(property.value);
}

function isSerializeProp(property) {
  return property.key.name === 'serialize' && utils.isFunctionExpression(property.value);
}

function isRedirectProp(property) {
  return property.key.name === 'redirect' && utils.isFunctionExpression(property.value);
}

function isActivateProp(property) {
  return property.key.name === 'activate' && utils.isFunctionExpression(property.value);
}

function isSetupControllerProp(property) {
  return property.key.name === 'setupController' && utils.isFunctionExpression(property.value);
}

function isRenderTemplateProp(property) {
  return property.key.name === 'renderTemplate' && utils.isFunctionExpression(property.value);
}

function isResetControllerProp(property) {
  return property.key.name === 'resetController' && utils.isFunctionExpression(property.value);
}

function isDeactivateProp(property) {
  return property.key.name === 'deactivate' && utils.isFunctionExpression(property.value);
}
