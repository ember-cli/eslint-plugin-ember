 ...
 * @param {string} importName the imported name to find (will return the alias of the import, of found)
 * @returns a {string} or null if no import is found with that name
 */
