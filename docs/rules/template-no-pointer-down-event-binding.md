...
- [eslint-plugin-ember template-no-pointer-down-event-binding](https://github.com/ember-cli/eslint-plugin-ember/blob/master/docs/rules/template-no-pointer-down-event-binding.md)
