...
- [eslint-plugin-ember template-no-redundant-landmark-role](https://github.com/ember-cli/eslint-plugin-ember/blob/master/docs/rules/template-no-redundant-landmark-role.md)
