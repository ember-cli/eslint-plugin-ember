...
- [ember-template-lint no-unsupported-role-attributes](https://github.com/ember-template-lint/ember-template-lint/blob/master/docs/rule/no-unsupported-role-attributes.md)
