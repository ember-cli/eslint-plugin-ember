...
| [no-decorators-before-export](docs/rules/no-decorators-before-export.md)                                               | disallow the use of a class decorator on an export declaration. Enforces use of the decorator on the class directly before exporting the result. | ✅  | 🔧 |    |
