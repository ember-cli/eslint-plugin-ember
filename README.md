...
If you are replacing `ember-template-lint` with this plugin, `recommended` already covers `.gjs`/`.gts` files: it enables every template rule from the `ember-template-lint` `recommended` preset that a strict-mode template can violate.

For `.hbs` files, add the `template-lint-migration` config. It keeps the full parity set, including the loose-mode-only rules that `recommended` leaves out:
...
`template-lint-migration` mirrors the ember-template-lint `recommended` preset. Applying it after `recommended` is harmless for `.gjs`/`.gts` files, since both set the same rules to `error`.
...
| Name                                                                                                             | Description                                                                      | 💼                                                                   | 🔧 | 💡 |
| :--------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------- | :------------------------------------------------------------------- | :- | :- |
| [template-link-href-attributes](docs/rules/template-link-href-attributes.md)                                     | require href attribute on link elements                                          | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-aria-unsupported-elements](docs/rules/template-no-aria-unsupported-elements.md)                     | disallow ARIA roles, states, and properties on elements that do not support them | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-duplicate-landmark-elements](docs/rules/template-no-duplicate-landmark-elements.md)                 | disallow duplicate landmark elements without unique labels                       | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-invalid-aria-attributes](docs/rules/template-no-invalid-aria-attributes.md)                         | disallow invalid aria-* attributes                                               | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-invalid-interactive](docs/rules/template-no-invalid-interactive.md)                                 | disallow non-interactive elements with interactive handlers                      | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-invalid-link-text](docs/rules/template-no-invalid-link-text.md)                                     | disallow invalid or uninformative link text content                              | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-invalid-link-title](docs/rules/template-no-invalid-link-title.md)                                   | disallow invalid title attributes on link elements                               | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-invalid-role](docs/rules/template-no-invalid-role.md)                                               | disallow invalid ARIA roles                                                      | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-nested-interactive](docs/rules/template-no-nested-interactive.md)                                   | disallow nested interactive elements                                             | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-nested-landmark](docs/rules/template-no-nested-landmark.md)                                         | disallow nested landmark elements                                                | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-pointer-down-event-binding](docs/rules/template-no-pointer-down-event-binding.md)                   | disallow pointer down event bindings                                             | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-redundant-role](docs/rules/template-no-redundant-role.md)                                           | disallow redundant role attributes                                               | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
| [template-no-unsupported-role-attributes](docs/rules/template-no-unsupported-role-attributes.md)                 | disallow ARIA attributes that are not supported by the element role              | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
| [template-no-whitespace-within-word](docs/rules/template-no-whitespace-within-word.md)                           | disallow excess whitespace within words (e.g. "W e l c o m e")                   | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-require-aria-activedescendant-tabindex](docs/rules/template-require-aria-activedescendant-tabindex.md) | require non-interactive elements with aria-activedescendant to have tabindex     | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
| [template-require-context-role](docs/rules/template-require-context-role.md)                                     | require ARIA roles to be used in appropriate context                             | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-require-input-label](docs/rules/template-require-input-label.md)                                       | require label for form input elements                                            | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-require-lang-attribute](docs/rules/template-require-lang-attribute.md)                                 | require lang attribute on html element                                           | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-require-mandatory-role-attributes](docs/rules/template-require-mandatory-role-attributes.md)           | require mandatory ARIA attributes for ARIA roles                                 | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-require-media-caption](docs/rules/template-require-media-caption.md)                                   | require captions for audio and video elements                                    | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-require-presentational-children](docs/rules/template-require-presentational-children.md)               | require presentational elements to only contain presentational children          | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-require-valid-alt-text](docs/rules/template-require-valid-alt-text.md)                                 | require valid alt text for images and other elements                             | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-table-groups](docs/rules/template-table-groups.md)                                                     | require table elements to use table grouping elements                            | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-builtin-component-arguments](docs/rules/template-builtin-component-arguments.md)                         | disallow setting certain attributes on builtin components                            | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-action-modifiers](docs/rules/template-no-action-modifiers.md)                                         | disallow usage of {{action}} modifiers                                               |                                                                      | 🔧 |    |
| [template-no-action-on-submit-button](docs/rules/template-no-action-on-submit-button.md)                           | disallow action attribute on submit buttons                                          | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-args-paths](docs/rules/template-no-args-paths.md)                                                     | disallow args.foo paths in templates, use @foo instead                               | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
| [template-no-arguments-for-html-elements](docs/rules/template-no-arguments-for-html-elements.md)                   | disallow @arguments on HTML elements                                                 | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-array-prototype-extensions](docs/rules/template-no-array-prototype-extensions.md)                     | disallow usage of Ember Array prototype extensions                                   | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
| [template-no-at-ember-render-modifiers](docs/rules/template-no-at-ember-render-modifiers.md)                       | disallow usage of @ember/render-modifiers                                            | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-block-params-for-html-elements](docs/rules/template-no-block-params-for-html-elements.md)             | disallow block params on HTML elements                                               | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-forbidden-elements](docs/rules/template-no-forbidden-elements.md)                                     | disallow specific HTML elements                                                      | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-index-component-invocation](docs/rules/template-no-index-component-invocation.md)                     | disallow index component invocations                                                 | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-inline-styles](docs/rules/template-no-inline-styles.md)                                               | disallow inline styles                                                               | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-invalid-meta](docs/rules/template-no-invalid-meta.md)                                                 | disallow invalid meta tags                                                           | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-nested-splattributes](docs/rules/template-no-nested-splattributes.md)                                 | disallow nested ...attributes usage                                                  | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-obscure-array-access](docs/rules/template-no-obscure-array-access.md)                                 | disallow obscure array access patterns like `objectPath.@each.property`              | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
...
| [template-no-passed-in-event-handlers](docs/rules/template-no-passed-in-event-handlers.md)                         | disallow passing event handlers directly as component arguments                      | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-positional-data-test-selectors](docs/rules/template-no-positional-data-test-selectors.md)             | disallow positional data-test-* params in curly invocations                          | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
| [template-no-potential-path-strings](docs/rules/template-no-potential-path-strings.md)                             | disallow potential path strings in attribute values                                  | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-redundant-fn](docs/rules/template-no-redundant-fn.md)                                                 | disallow unnecessary usage of (fn) helper                                            | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
...
| [template-no-template-lint-directives](docs/rules/template-no-template-lint-directives.md)                         | disallow `{{! template-lint-* }}` directives (use the `{{! eslint-* }}` equivalents) | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
...
| [template-no-unnecessary-component-helper](docs/rules/template-no-unnecessary-component-helper.md)                 | disallow unnecessary component helper                                                | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
| [template-no-unnecessary-concat](docs/rules/template-no-unnecessary-concat.md)                                     | disallow unnecessary string concatenation                                            |                                                                      | 🔧 |    |
| [template-no-unnecessary-curly-parens](docs/rules/template-no-unnecessary-curly-parens.md)                         | disallow unnecessary parentheses enclosing statements in curlies                     | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
| [template-no-unused-block-params](docs/rules/template-no-unused-block-params.md)                                   | disallow unused block parameters in templates                                        | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-whitespace-for-layout](docs/rules/template-no-whitespace-for-layout.md)                               | disallow using whitespace for layout purposes                                        | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-yield-only](docs/rules/template-no-yield-only.md)                                                     | disallow components that only yield                                                  | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-yield-to-default](docs/rules/template-no-yield-to-default.md)                                         | disallow yield to default block                                                      | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-require-has-block-helper](docs/rules/template-require-has-block-helper.md)                               | require (has-block) helper usage instead of hasBlock property                        | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
...
| [template-require-valid-named-block-naming-format](docs/rules/template-require-valid-named-block-naming-format.md) | require valid named block naming format                                              | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
...
| [template-simple-modifiers](docs/rules/template-simple-modifiers.md)                                               | require simple modifier syntax                                                       | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-style-concatenation](docs/rules/template-style-concatenation.md)                                         | disallow string concatenation in inline styles                                       | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| [template-no-link-to-positional-params](docs/rules/template-no-link-to-positional-params.md)     | disallow positional params in LinkTo component                                             | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-link-to-tagname](docs/rules/template-no-link-to-tagname.md)                         | disallow tagName attribute on LinkTo component                                             | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
...
| Name                                                                                                                       | Description                                                       | 💼                                                                   | 🔧 | 💡 |
| :------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------- | :------------------------------------------------------------------- | :- | :- |
| [template-no-extra-mut-helper-argument](docs/rules/template-no-extra-mut-helper-argument.md)                               | disallow passing more than one argument to the mut helper         | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-jsx-attributes](docs/rules/template-no-jsx-attributes.md)                                                     | disallow JSX-style camelCase attributes                           |                                                                      | 🔧 |    |
| [template-no-scope-outside-table-headings](docs/rules/template-no-scope-outside-table-headings.md)                         | disallow scope attribute outside th elements                      | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-shadowed-elements](docs/rules/template-no-shadowed-elements.md)                                               | disallow ambiguity with block param names shadowing HTML elements | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-unbalanced-curlies](docs/rules/template-no-unbalanced-curlies.md)                                             | disallow unbalanced mustache curlies                              | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 |    |    |
| [template-no-unknown-arguments-for-builtin-components](docs/rules/template-no-unknown-arguments-for-builtin-components.md) | disallow unknown arguments for built-in components                | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
...
| Name                                                                                         | Description                                                | 💼                                                                   | 🔧 | 💡 |
| :------------------------------------------------------------------------------------------- | :--------------------------------------------------------- | :------------------------------------------------------------------- | :- | :- |
| [template-no-quoteless-attributes](docs/rules/template-no-quoteless-attributes.md)           | require quotes on all attribute values                     | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
| [template-no-unnecessary-curly-strings](docs/rules/template-no-unnecessary-curly-strings.md) | disallow unnecessary curly braces in string interpolations | ✅ ![gjs logo](/docs/svgs/gjs.svg) ![gts logo](/docs/svgs/gts.svg) 📋 | 🔧 |    |
