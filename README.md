...
module.exports = [...eslintPluginEmberRecommended];
```
...
| [template-no-redundant-role](docs/rules/template-no-redundant-role.md)                                           | disallow redundant role attributes                                               | ✅ ![badge-strict-gjs][] ![badge-strict-gts][] | 🔧 |    |
...
| Name                                                                                                                   | Description                                                             | 💼                                            | 🔧 | 💡 |
| :--------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------- | :-------------------------------------------- | :- | :- |
| [template-builtin-component-arguments](docs/rules/template-builtin-component-arguments.md)                             | disallow setting certain attributes on builtin components               | ![badge-strict-gjs][] ![badge-strict-gts][]   |    |    |
...
| [template-no-curly-component-invocation](docs/rules/template-no-curly-component-invocation.md)                         | disallow curly component invocation, use angle bracket syntax instead   | ✅ ![badge-strict-gjs][] ![badge-strict-gts][] |    |    |
...
| [template-no-index-component-invocation](docs/rules/template-no-index-component-invocation.md)                         | disallow index component invocations                                    | ✅ ![badge-strict-gjs][] ![badge-strict-gts][] |    |    |
...
| [template-no-splattributes-with-class](docs/rules/template-no-splattributes-with-class.md)                             | disallow splattributes with class attribute                             | ✅ ![badge-strict-gjs][] ![badge-strict-gts][] |    |    |
...
| [template-no-unused-block-params](docs/rules/template-no-unused-block-params.md)                                       | disallow unused block parameters in templates                           | ![badge-strict-gjs][] ![badge-strict-gts][]   |    |    |
...
| [template-no-yield-block-params-to-else-inverse](docs/rules/template-no-yield-block-params-to-else-inverse.md)         | disallow yielding block params to else or inverse block                 | ✅ ![badge-strict-gjs][] ![badge-strict-gts][] |    |    |
...
| [template-require-iframe-src-attribute](docs/rules/template-require-iframe-src-attribute.md)                           | require iframe elements to have src attribute                           | ✅ ![badge-strict-gjs][] ![badge-strict-gts][] |    |    |
| [template-require-splattributes](docs/rules/template-require-splattributes.md)                                         | require splattributes usage in component templates                      | ✅ ![badge-strict-gjs][] ![badge-strict-gts][] |    |    |
| [template-require-strict-mode](docs/rules/template-require-strict-mode.md)                                             | require templates to be in strict mode                                  |                                               |    |    |
| [template-require-valid-named-block-naming-format](docs/rules/template-require-valid-named-block-naming-format.md)     | require valid named block naming format                                 | ✅ ![badge-strict-gjs][] ![badge-strict-gts][] |    |    |
...
| [template-simple-modifiers](docs/rules/template-simple-modifiers.md)                                                   | require simple modifier syntax                                          | ✅ ![badge-strict-gjs][] ![badge-strict-gts][] |    |    |
...
| Name                                                                                                                       | Description                                               | 💼                                            | 🔧 | 💡 |
| :------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------- | :-------------------------------------------- | :- | :- |
| [template-no-extra-mut-helper-argument](docs/rules/template-no-extra-mut-helper-argument.md)                               | disallow passing more than one argument to the mut helper | ✅ ![badge-strict-gjs][] ![badge-strict-gts][] |    |    |
| [template-no-jsx-attributes](docs/rules/template-no-jsx-attributes.md)                                                     | disallow JSX-style camelCase attributes                   | ![badge-strict-gjs][] ![badge-strict-gts][]   | 🔧 |    |
...
| [template-inline-link-to](docs/rules/template-inline-link-to.md)             | disallow inline link-to, use the block form instead            | ![badge-strict-gjs][] ![badge-strict-gts][] | 🔧 |    |
| [template-modifier-name-case](docs/rules/template-modifier-name-case.md)     | require dasherized names for modifiers                         | ![badge-strict-gjs][] ![badge-strict-gts][] | 🔧 |    |
| [template-no-only-default-slot](docs/rules/template-no-only-default-slot.md) | disallow using only the default slot                           | ![badge-strict-gjs][] ![badge-strict-gts][] | 🔧 |    |
